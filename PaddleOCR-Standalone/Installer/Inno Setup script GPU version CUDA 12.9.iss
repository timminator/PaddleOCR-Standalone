...
[Files]
Source: "..\PaddleOCR GPU\PaddleOCR-GPU-v1.3.2-CUDA-12.9\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\PaddleOCR GPU\PaddleOCR-GPU-v1.3.2-CUDA-12.9\*.*"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\PaddleOCR GPU\PaddleOCR-GPU-v1.3.2-CUDA-12.9\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
