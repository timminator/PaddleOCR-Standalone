...
[Files]
Source: "..\PaddleOCR GPU\PaddleOCR-GPU-v1.4.0-CUDA-12.9\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\PaddleOCR GPU\PaddleOCR-GPU-v1.4.0-CUDA-12.9\*.*"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\PaddleOCR GPU\PaddleOCR-GPU-v1.4.0-CUDA-12.9\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
