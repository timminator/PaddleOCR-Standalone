...
[Files]
Source: "..\PaddleOCR CPU\PaddleOCR-CPU-v1.3.2\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\PaddleOCR CPU\PaddleOCR-CPU-v1.3.2\*.*"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\PaddleOCR CPU\PaddleOCR-CPU-v1.3.2\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
