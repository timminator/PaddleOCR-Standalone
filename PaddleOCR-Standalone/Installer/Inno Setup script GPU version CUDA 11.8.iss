...
SetupIconFile=..\Wrappers\GPU-CUDA-11.8\paddleocr.ico
...
[Files]
Source: "..\Wrappers\GPU-CUDA-11.8\wrapper.dist\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Wrappers\GPU-CUDA-11.8\wrapper.dist\*.*"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Wrappers\GPU-CUDA-11.8\wrapper.dist\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
